// FuelIQ Weight Journey Module - Fixed Version
(function() {
    // Prevent multiple loading
    if (window.FuelIQWeightJourney) {
        return;
    }

    // Safe Storage Functions (scoped within IIFE)
    ...
    const renderWeightJourney = (containerId) => {
        ...
        if (container) {
            ReactDOM.render(React.createElement(WeightJourney), container);
        }
    };
